...
<div id="botoes" style="width:50%; background:#fff; margin:auto; padding-bottom:10px;"> 
	...
	<p></p>
	<a href='os_pdf.php?id=<?php echo $OsId; ?>' target="_blank" class="vsubmit"> Imprimir </a>
...
<tr><td width="50%"><b>Hora de Início: </b><?php echo ($OsData);?></td><td><b>Hora de Término: </b><?php echo ($OsDataEntrega);?>
