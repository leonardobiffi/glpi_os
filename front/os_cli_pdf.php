...
<!-- segunda tabela -->
<tr><td colspan="2" class="titulo"><center><b><font color="black">DADOS DO CLIENTE</font></b></center></td> </tr>
<tr><td width="50%"><b>Nome: </b>'.($UserName).'</td><td ><b>Telefone: </b>'.($UserTelefone).'</td></tr>
<tr><td width="50%"><b>Endereço: </b>'.($UserEndereco).'</td><td><b>E-Mail: </b>'.($UserEmail).'</td></tr>
<tr><td width="50%"><b>CPF: </b>'.($UserCpf).'</td><td ><b>CEP: </b>'.($UserCep).'</td></tr>

<!-- tabela OS -->
<tr>
    <td colspan="2" class="titulo"><center><b><font color="black">DETALHES DA ORDEM DE SERVIÇO</font></b></center></td>
</tr>
<tr>
...
<tr>
    <td colspan="2" class="titulo"><center><b><font color="black">DESCRIÇÃO</font></b></center></td>
</tr>
<tr>
    <td colspan="2" valign="top" style="padding:10px;">'.html_entity_decode($OsDescricao).'</td>
</tr>
<tr>
    <td colspan="2" class="titulo"><center><b><font color="black">SOLUÇÃO</font></b></center></td>
</tr>
<tr>
...
<tr align="center"><td style="text-align:center;" >'.($UserName).'</td><td style="text-align:center;" >'.($EmpresaPlugin).'</td></tr>
</table>
</table> 
</body>
</html>';
